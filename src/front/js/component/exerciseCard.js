...
const ExerciseCard = ({ exercise, id, target, equipment, bodypart, url }) => {
  ...
  return (
    <div
      className="wrap-exercise-card d-flex  p-0 pb-2 bg-vital-gray mt-4 border border-1 rounded-3 border-vital-orange"
     style={{ width: "500px" }}
    >
      {
      ...
      <div className="d-flex flex-column justify-content-center p-2 " style={{width: "300px"}}>
        <div
          className="rounded-3  d-flex flex-column w-100 h-100 justify-content-center align-items-center"
        >
          <h2 className="text-vital-white text-center fw-bold excercise-title">
            <Link
